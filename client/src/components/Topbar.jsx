...
export default function Topbar({ onMenuClick, title, subtitle }) {
  ...
  return (
    <header className="sticky top-0 z-20 flex min-w-0 items-center gap-4 border-b border-gray-100 bg-white/90 px-4 py-3 backdrop-blur sm:px-6">
      <button
        onClick={onMenuClick}
      ...
      <div className="min-w-0 flex-1">
        {title && <h1 className="truncate font-display text-lg font-bold text-gray-900">{title}</h1>}
      ...
      <div className="ml-auto flex items-center gap-3">
        <button
          className="relative shrink-0 rounded-full p-2 text-gray-500 hover:bg-gray-100"
        ...
        <Link to="/settings" className="flex shrink-0 items-center gap-2">
